...
class SecondBoard extends JPanel{
	
	Image background = new ImageIcon("Garden.jpg").getImage(); 
...
class SecondPlantBoard extends JPanel{

	Image background = new ImageIcon("Woodpanel.jpg").getImage(); 
	
	public SecondPlantBoard(){
		super();
...
public class SecondMapView extends JFrame{
	...
	private ImageIcon sunflowerico = new ImageIcon(new ImageIcon("Zombie.gif").getImage().getScaledInstance(screenwidth/18, screenheight/7, Image.SCALE_DEFAULT));
	private ImageIcon peashooterico = new ImageIcon(new ImageIcon("Conezombie2.gif").getImage().getScaledInstance(screenwidth/18, screenheight/7, Image.SCALE_DEFAULT));
	private ImageIcon cherrybombico = new ImageIcon(new ImageIcon("Flagzombie.gif").getImage().getScaledInstance(screenwidth/18, screenheight/7, Image.SCALE_DEFAULT));
	...
	private ImageIcon zombieico = new ImageIcon(new ImageIcon("Sunflower.gif").getImage().getScaledInstance(screenwidth/21, screenheight/12, Image.SCALE_DEFAULT));
	private ImageIcon conezombieico = new ImageIcon(new ImageIcon("Peashooter2.gif").getImage().getScaledInstance(screenwidth/19, screenheight/12, Image.SCALE_DEFAULT));
	private ImageIcon flagzombieico = new ImageIcon(new ImageIcon("Cherrybomb.gif").getImage().getScaledInstance(screenwidth/19, screenheight/12, Image.SCALE_DEFAULT));
	private ImageIcon peaico = new ImageIcon(new ImageIcon("Pea2.gif").getImage().getScaledInstance(screenwidth/50, screenheight/25, Image.SCALE_DEFAULT));
    ...
    private SecondBoard board = new SecondBoard();
	private JPanel rowboard = new JPanel();
    private SecondPlantBoard plantboard = new SecondPlantBoard();
    ...
    public void addSunflower(int row, int col){
        ...
        plants[row][col].setBounds(insets.left+screenwidth/120,insets.top+screenheight/31,screenwidth/18, screenheight/7);
    }
