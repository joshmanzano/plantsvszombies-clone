...
public class SecondMapController{
    ...
    private SecondMapView mapview;
    private SecondMapModel mapmodel;
    ...
    public SecondMapController(SecondMapView mapview, SecondMapModel mapmodel){
		...
		interval = 180 * mapmodel.getGamespeed(); 
		interval2 = 1800 * mapmodel.getGamespeed();	
		won = true;
          ...
          public void run(){
			 ...
			 try{
				 ...
				 while(setInterval()){
					 ...
					 if((180 * mapmodel.getGamespeed() - (interval * mapmodel.getGamespeed())) >= (30 * mapmodel.getGamespeed()) && (180 * mapmodel.getGamespeed() - (interval * mapmodel.getGamespeed())) <= (80 * mapmodel.getGamespeed()) && (180 * mapmodel.getGamespeed() - (interval * mapmodel.getGamespeed())) % (10 * mapmodel.getGamespeed()) == 0){
						 for(int i = 0 ; i < 2 ; i++){
							 int row = random.nextInt(5);
							 mapmodel.addZombie(new Zombie(50,10,4,row,8));
							 mapview.addZombie(row); 						 
						 }
					 }else if((180 * mapmodel.getGamespeed() - (interval * mapmodel.getGamespeed())) >= (81 * mapmodel.getGamespeed()) && (180 * mapmodel.getGamespeed() - (interval * mapmodel.getGamespeed())) <= (140 * mapmodel.getGamespeed()) && (180 * mapmodel.getGamespeed() - (interval * mapmodel.getGamespeed())) % (5 * mapmodel.getGamespeed()) == 0){
					 ...
					 }else if((180 * mapmodel.getGamespeed() - (interval * mapmodel.getGamespeed())) >= (141 * mapmodel.getGamespeed()) && (180 * mapmodel.getGamespeed() - (interval * mapmodel.getGamespeed())) <= (170 * mapmodel.getGamespeed()) && (180 * mapmodel.getGamespeed() - (interval * mapmodel.getGamespeed())) % (3 * mapmodel.getGamespeed()) == 0){
						 for(int i = 0 ; i < 2 ; i++){
							 int row = random.nextInt(5);
							 mapmodel.addZombie(new Zombie(50,10,4,row,8));
							 mapview.addZombie(row); 						 
						 }
					 }else if((180 * mapmodel.getGamespeed() - (interval * mapmodel.getGamespeed())) == (171 * mapmodel.getGamespeed())){
						 int row = random.nextInt(5);
